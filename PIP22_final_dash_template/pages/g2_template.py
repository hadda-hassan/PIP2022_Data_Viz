...
from text import txt_g2 ## import le modul txt_g1 pour utiliser les cases text
from graphes import graphe_g2 ## import le modul des graphes 
...
########## Premier ligne de contenu layout contient deux graphes avec deux cases text pour l'explication        
                   ...
                   html.Div([
                            ...
                            html.Div([txt_g2.cont_txt_1] ,className="six columns",),  ## text 1
                            html.Div([txt_g2.cont_txt_1],className="six columns",),  ## text 2
                        ],
                        className="row ",),
 ##############################################################################################################"#     
 ###### deuxiéme ligne de contenu layout de ce groupe contient 3 graphe avec 3 cases du text pour l'explication.  
                      ...
                      html.Div([ ### les graphes
                        html.Div([dcc.Graph(figure=graphe_g2.fig7),],className="four columns",), ## graphe fig7
                         
                        html.Div([dcc.Graph(figure=graphe_g2.fig6),],className="four columns",), ## graphe fig6
                         
                        html.Div([dcc.Graph(figure=graphe_g2.fig4),],className="four columns",), ## graphe fig4
                        ],
                        className="row ",),
     
                        html.Div([ ## les trois cases
                            html.Div([txt_g2.cont_txt_1],className="four columns",),
                            html.Div([txt_g2.cont_txt_1],className="four columns",),
                            html.Div([txt_g2.cont_txt_1],className="four columns",),
                        ],
                        className="row ",),        
...
#                                     html.Strong("Titre comm 2",style={"color": "#3a3a3a"}, ),
                                    dcc.Graph(figure=graphe_g2.fig3),],className="twelve columns",), ##fig 2
                                 ], className="row ",),
     
                        html.Div([
                            html.Div([txt_g2.cont_txt_1],className="twelve columns",),  ## casetext 
                        ], className="row ",),
...
def create_layout(app):
    ...
    return html.Div(
        [html.Div([Header(app)]), 
               html.Div([html.Div( [html.H5("Objectif du groupe 2"),html.Br([]), html.P("\L'objectif du groupe est de ....", 
